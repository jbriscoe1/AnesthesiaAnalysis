...
%% Input Files
spectrumDirectory = '\\rfa01.research.partners.org\MGH-ISHIZAWA\Jessica\propofolAnalysis\Data\SpectrumData\PFData\14to40HzWindow\Ewok\S1';
spectrumDataFiles = dir([spectrumDirectory, '/*.mat']);

%Save Folder
saveFileName = '\\rfa01.research.partners.org\MGH-ISHIZAWA\Jessica\propofolAnalysis\Statistics\peakFrequency\Spectrum\S1';
...
for j = 1:length(uniqueSessions)
    ...
    for rr = 1:size(rocSpectralData, 2)
        ...
        rocPeakFreq = rocPeakFreq(rocPeakFreq >=16 & rocPeakFreq<=32);         
    end
    ...
    clear awakePeakFreq awakeSpectralData awakeIndexPeakFreq rocPeakFreq rocSpectralData rocIndexPeakFreq ropapPeakFreq ropapSpectralData ropapIndexPeakFreq
